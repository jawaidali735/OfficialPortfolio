...
export default function About() {
    return (
        <div className="flex flex-col items-center px-6 pt-24 lg:px-36 bg-[#07151f] text-white text-center py-12 relative w-full">
            <h1 className="text-4xl font-bold mb-8">About <span className="text-[#00abcf]">Me</span></h1>
            <div className="relative w-full flex flex-col items-center">
                <div className="absolute h-full w-1 bg-[#00abcf] z-0" style={{ left: "50%", top: "0" }} />
